...
000000000040129b <main>:
  ...
  4012aa:	48 89 75 e0          	mov    %rsi,-0x20(%rbp) // "\276\345\377\377\377\177" is stored at the pointer rsi
  4012ae:	41 b9 00 00 00 00    	mov    $0x0,%r9d
  4012b4:	41 b8 00 00 00 00    	mov    $0x0,%r8d
  4012ba:	b9 32 01 00 00       	mov    $0x132,%ecx //Holds the value 306
  4012bf:	ba 07 00 00 00       	mov    $0x7,%edx //holds the value 7
